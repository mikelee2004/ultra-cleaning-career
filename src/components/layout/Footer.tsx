    ...
    <footer id="contacts" className="bg-[#1C2B3A] text-white pt-20 pb-10">
      <div className="max-w-[1240px] mx-auto px-5">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16 mb-20">
          ...
          {/* Brand */}
          <div>
            <a href={BASE} className="flex items-center gap-2.5 mb-6 no-underline">
          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <a href="mailto:commerce@uclea.ru"
                className="flex items-center gap-3 no-underline text-white text-lg font-extrabold hover:text-white/80 transition-colors">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-wrap justify-between gap-5 text-sm text-white/40">
          ...
          <div className="flex gap-6">
            <a href={`${BASE}/offer`} className="text-white/40 no-underline hover:text-white transition-colors">
              Публичная оферта
            </a>
            <a href={`${BASE}/privacy`} className="text-white/40 no-underline hover:text-white transition-colors">
              Политика конфиденциальности
            </a>
            <a href="https://scaleangel.ru" target="_blank" rel="noopener noreferrer"
